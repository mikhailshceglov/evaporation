...
#Расчёт часового, полусуточного и суточного испарения
...
calc_result/
- evap_hourly.xlsx	Часовые значения испарения
- evap_half_daily.xlsx	Полусуточные значения (00–12, 12–24)
- evap_daily.xlsx	Суточные суммы испарения
- *.csv	Аналогичные данные в CSV-формате
Испарение с поправкой на температуру воды

#Расчет испарения с поправкой на температуру

##Запуск расчёта с температурной поправкой
python3 calc_evaporation_corrected.py

#Результат
Результаты сохраняются в папке:
calc_result_with_temperature
